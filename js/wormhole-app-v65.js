...
import { TwitchAuth } from './twitch-auth.js?v=65';
import { TwitchApi } from './twitch-api.js?v=65';
import { applyHardFilters, findRaidMatches } from './raid-match.js?v=65';
import { RaidListener } from './raid-listener.js?v=65';
import { ViewerHistory } from './viewer-history.js?v=65';
import { PreviousStreamHistory } from './previous-stream-history.js?v=65';
import { paginate } from './pagination.js?v=65';
import { sortRaidMatches } from './result-sort.js?v=65';
import { calculateViewerRange, parseViewerTolerance } from './viewer-tolerance.js?v=65';
import {
  createRaidCountdown,
  getRaidCountdownSnapshot,
} from './raid-countdown.js?v=65';
import { ChannelHistory } from './channel-history.js?v=65';
import { estimateStreamEnd, parseTwitchDuration } from './stream-end-estimate.js?v=65';
import {
  getGenreGameNames,
  getGenreLabelsForGame,
} from './genre-presets.js?v=65';
import { applyLanguageTag, isLanguageTag } from './language-tags.js?v=65';
import { prepareTagDisplay } from './tag-display.js?v=65';
import { normalizeTwitchLogin } from './direct-search.js?v=65';
import { buildTwitchPlayerUrl, buildTwitchWatchUrl } from './twitch-player.js?v=65';
import { buildFollowedDirectoryMatches } from './followed-directory.js?v=65';
import { resolveDiscoveryMode } from './discovery-mode.js?v=65';
import { loadFilterPreset, saveFilterPreset } from './filter-preset-storage.js?v=65';
import {
  buildRaidCompletionMessage,
  getRaidDestinationEmbedUrls,
  getTwitchRaidControlsUrl,
  isMatchingRaidConfirmation,
} from './raid-completion.js?v=65';
...
el.loginBtn.addEventListener('click', () => {
  if (TWITCH_CONFIG.clientId === 'YOUR_TWITCH_CLIENT_ID') {
    el.loginError.textContent =
      'Set your Twitch Client ID in js/twitch-config-v65.js before logging in.';
    return;
  }
  try {
