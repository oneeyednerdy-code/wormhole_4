...
Open `js/twitch-config-v52.js` and paste it in:
...
`redirectUriOverride` in `js/twitch-config-v52.js` to the one production callback you
...
js/
  twitch-config-v52.js # Client ID, scopes, redirect URI
  ...
  wormhole-app-v52.js # Wires everything together, renders the UI
tests/
