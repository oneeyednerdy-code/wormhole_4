...
import { TwitchAuth } from './twitch-auth.js?v=58';
import { TwitchApi } from './twitch-api.js?v=58';
import { applyHardFilters, findRaidMatches } from './raid-match.js?v=58';
import { RaidListener } from './raid-listener.js?v=58';
import { ViewerHistory } from './viewer-history.js?v=58';
import { PreviousStreamHistory } from './previous-stream-history.js?v=58';
import { paginate } from './pagination.js?v=58';
import { sortRaidMatches } from './result-sort.js?v=58';
import { calculateViewerRange, parseViewerTolerance } from './viewer-tolerance.js?v=58';
import {
  createRaidCountdown,
  getRaidCountdownSnapshot,
} from './raid-countdown.js?v=58';
import { ChannelHistory } from './channel-history.js?v=58';
import { estimateStreamEnd, parseTwitchDuration } from './stream-end-estimate.js?v=58';
import {
  getGenreGameNames,
  getGenreLabelsForGame,
} from './genre-presets.js?v=58';
import { applyLanguageTag, isLanguageTag } from './language-tags.js?v=58';
import { prepareTagDisplay } from './tag-display.js?v=58';
import { normalizeTwitchLogin } from './direct-search.js?v=58';
import { buildTwitchPlayerUrl, buildTwitchWatchUrl } from './twitch-player.js?v=58';
import { buildFollowedDirectoryMatches } from './followed-directory.js?v=58';
import { loadFilterPreset, saveFilterPreset } from './filter-preset-storage.js?v=58';
import {
  buildRaidCompletionMessage,
  getRaidDestinationEmbedUrls,
  getTwitchRaidControlsUrl,
  isMatchingRaidConfirmation,
} from './raid-completion.js?v=58';
...
el.loginBtn.addEventListener('click', () => {
  if (TWITCH_CONFIG.clientId === 'YOUR_TWITCH_CLIENT_ID') {
    el.loginError.textContent =
      'Set your Twitch Client ID in js/twitch-config-v58.js before logging in.';
    return;
  }
  try {
