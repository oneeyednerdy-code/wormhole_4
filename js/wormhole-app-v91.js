...
import { TwitchAuth } from './twitch-auth.js?v=91';
import { TwitchApi } from './twitch-api.js?v=91';
...
import { attachContentClassificationLabels } from './services/content-labels.js?v=91';
import { logger } from './app/logger.js?v=91';
import { recentActivityHtml } from './results/recent-activity.js?v=91';
import { configureResultsController, renderResults } from './results/controller.js?v=91';
import { configureRaidController, clearActiveRaid, handleRaidCompleted, openRaidDialog } from './raid/controller.js?v=91';
import { applyHardFilters, findRaidMatches } from './raid-match.js?v=91';
import { configureSearchController, invalidateSearch, runSearch } from './search/controller.js?v=91';
import {
...
} from './search/filters.js?v=91';
import { runCategorySearch, renderSelectedCategories } from './search/categories.js?v=91';
import { loadingCardsHtml, showSearchStatus, showResultNotice, configureSearchUi } from './search/ui.js?v=91';
import { RaidListener } from './raid-listener.js?v=91';
...
import { calculateViewerRange, describeViewerRange, parseViewerTolerance } from './viewer-tolerance.js?v=91';
import {
  createRaidCountdown,
  getRaidCountdownSnapshot,
} from './raid-countdown.js?v=91';
import { ChannelHistory } from './channel-history.js?v=91';
import { estimateStreamEnd, parseTwitchDuration } from './stream-end-estimate.js?v=91';
import {
  getGenreGameNames,
  getGenreLabelsForGame,
} from './genre-presets.js?v=91';
...
import { normalizeTwitchLogin } from './direct-search.js?v=91';
import { buildTwitchPlayerUrl, buildTwitchWatchUrl } from './twitch-player.js?v=91';
...
} from './raid-completion.js?v=91';
import { DiagnosticsLog } from './diagnostics.js?v=91';
...
el.loginBtn.addEventListener('click', () => {
  if (TWITCH_CONFIG.clientId === 'YOUR_TWITCH_CLIENT_ID') {
    el.loginError.textContent =
      'Set your Twitch Client ID in js/twitch-config-v91.js before logging in.';
    return;
  }
  try {
