...
import { TwitchAuth } from './twitch-auth.js?v=67';
import { TwitchApi } from './twitch-api.js?v=67';
import { applyHardFilters, findRaidMatches } from './raid-match.js?v=67';
import { RaidListener } from './raid-listener.js?v=67';
import { ViewerHistory } from './viewer-history.js?v=67';
import { PreviousStreamHistory } from './previous-stream-history.js?v=67';
import { paginate } from './pagination.js?v=67';
import { sortRaidMatches } from './result-sort.js?v=67';
import { calculateViewerRange, parseViewerTolerance } from './viewer-tolerance.js?v=67';
import {
  createRaidCountdown,
  getRaidCountdownSnapshot,
} from './raid-countdown.js?v=67';
import { ChannelHistory } from './channel-history.js?v=67';
import { estimateStreamEnd, parseTwitchDuration } from './stream-end-estimate.js?v=67';
import {
  getGenreGameNames,
  getGenreLabelsForGame,
} from './genre-presets.js?v=67';
import { isLanguageTag, parseTagInput } from './language-tags.js?v=67';
import { prepareTagDisplay } from './tag-display.js?v=67';
import { normalizeTwitchLogin } from './direct-search.js?v=67';
import { buildTwitchPlayerUrl, buildTwitchWatchUrl } from './twitch-player.js?v=67';
import { buildFollowedDirectoryMatches } from './followed-directory.js?v=67';
import { resolveDiscoveryMode } from './discovery-mode.js?v=67';
import { loadFilterPreset, saveFilterPreset } from './filter-preset-storage.js?v=67';
import {
  buildRaidCompletionMessage,
  getRaidDestinationEmbedUrls,
  getTwitchRaidControlsUrl,
  isMatchingRaidConfirmation,
} from './raid-completion.js?v=67';
...
el.loginBtn.addEventListener('click', () => {
  if (TWITCH_CONFIG.clientId === 'YOUR_TWITCH_CLIENT_ID') {
    el.loginError.textContent =
      'Set your Twitch Client ID in js/twitch-config-v67.js before logging in.';
    return;
  }
  try {
