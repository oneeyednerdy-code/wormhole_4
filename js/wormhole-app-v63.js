...
import { TwitchAuth } from './twitch-auth.js?v=63';
import { TwitchApi } from './twitch-api.js?v=63';
import { applyHardFilters, findRaidMatches } from './raid-match.js?v=63';
import { RaidListener } from './raid-listener.js?v=63';
import { ViewerHistory } from './viewer-history.js?v=63';
import { PreviousStreamHistory } from './previous-stream-history.js?v=63';
import { paginate } from './pagination.js?v=63';
import { sortRaidMatches } from './result-sort.js?v=63';
import { calculateViewerRange, parseViewerTolerance } from './viewer-tolerance.js?v=63';
import {
  createRaidCountdown,
  getRaidCountdownSnapshot,
} from './raid-countdown.js?v=63';
import { ChannelHistory } from './channel-history.js?v=63';
import { estimateStreamEnd, parseTwitchDuration } from './stream-end-estimate.js?v=63';
import {
  getGenreGameNames,
  getGenreLabelsForGame,
} from './genre-presets.js?v=63';
import { applyLanguageTag, isLanguageTag } from './language-tags.js?v=63';
import { prepareTagDisplay } from './tag-display.js?v=63';
import { normalizeTwitchLogin } from './direct-search.js?v=63';
import { buildTwitchPlayerUrl, buildTwitchWatchUrl } from './twitch-player.js?v=63';
import { buildFollowedDirectoryMatches } from './followed-directory.js?v=63';
import { loadFilterPreset, saveFilterPreset } from './filter-preset-storage.js?v=63';
import {
  buildRaidCompletionMessage,
  getRaidDestinationEmbedUrls,
  getTwitchRaidControlsUrl,
  isMatchingRaidConfirmation,
} from './raid-completion.js?v=63';
...
el.loginBtn.addEventListener('click', () => {
  if (TWITCH_CONFIG.clientId === 'YOUR_TWITCH_CLIENT_ID') {
    el.loginError.textContent =
      'Set your Twitch Client ID in js/twitch-config-v63.js before logging in.';
    return;
  }
  try {
