...
import { TwitchAuth } from './twitch-auth.js?v=53';
import { TwitchApi } from './twitch-api.js?v=53';
import { applyHardFilters, findRaidMatches } from './raid-match.js?v=53';
import { RaidListener } from './raid-listener.js?v=53';
import { ViewerHistory } from './viewer-history.js?v=53';
import { PreviousStreamHistory } from './previous-stream-history.js?v=53';
import { paginate } from './pagination.js?v=53';
import { sortRaidMatches } from './result-sort.js?v=53';
import { calculateViewerRange, parseViewerTolerance } from './viewer-tolerance.js?v=53';
import {
  createRaidCountdown,
  getRaidCountdownSnapshot,
} from './raid-countdown.js?v=53';
import { ChannelHistory } from './channel-history.js?v=53';
import { estimateStreamEnd, parseTwitchDuration } from './stream-end-estimate.js?v=53';
import {
  getGenreGameNames,
  getGenreLabelsForGame,
} from './genre-presets.js?v=53';
import { applyLanguageTag, isLanguageTag } from './language-tags.js?v=53';
import { prepareTagDisplay } from './tag-display.js?v=53';
import { normalizeTwitchLogin } from './direct-search.js?v=53';
import { buildFollowedDirectoryMatches } from './followed-directory.js?v=53';
import { loadFilterPreset, saveFilterPreset } from './filter-preset-storage.js?v=53';
import {
  buildRaidCompletionMessage,
  getRaidDestinationEmbedUrls,
  getTwitchRaidControlsUrl,
  isMatchingRaidConfirmation,
} from './raid-completion.js?v=53';
...
el.loginBtn.addEventListener('click', () => {
  if (TWITCH_CONFIG.clientId === 'YOUR_TWITCH_CLIENT_ID') {
    el.loginError.textContent =
      'Set your Twitch Client ID in js/twitch-config-v53.js before logging in.';
    return;
  }
  try {
